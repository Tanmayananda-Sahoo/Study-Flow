...
// import { getSchedule } from '../utils/timeTableFunctionality.js'
...
//   { type: 'task', dot: 'bg-green-500',  label: 'Task'  },
...
//       console.log("Use effect schedule:", response);
//     }
...
//     <div>
//       {/* Header */}
//       <h1 className="text-3xl font-semibold text-ink tracking-tighter mb-0.5">Smart Schedule</h1>
...
export default function SchedulePage() {
  ...
  useEffect(() => {
    ...
    async function loadData() {
      ...
      // assuming backend returns { schedule: [...] }
  ...
  return (
    <div>
      {/* Header */}
      <h1 className="text-3xl font-semibold text-ink tracking-tighter mb-0.5">
        Smart Schedule
      </h1>
      <p className="text-md text-ink-muted mb-6">
        AI-optimised study plan
      </p>
